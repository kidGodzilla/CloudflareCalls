...
class CloudflareCalls {
    ...
    constructor(config = {}) {
        ...
        // Default quality settings (moved from constructor)
        this.mediaQuality = CloudflareCalls.QUALITY_PRESETS.medium_16x9_md;

        // Make QUALITY_PRESETS available on instance
        ...
        this.previousStats = null;  // Add this to track previous stats
    ...
    startStatsMonitoring(interval = 1000) {
        ...
        this.statsInterval = setInterval(async () => {
            ...
            this.statsCallbacks.forEach(callback => callback(stats, streamStats));
        }, interval);
    }
...
// +           this.previousStats = null;  // Clear previous stats
    ...
    /**
     * Unregister a stats callback
     * @param {function} callback - The callback to remove
     */
    offConnectionStats(callback) {
